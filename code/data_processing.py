...
companies_rounds_sector = pd.read_csv("../data/final_data.csv", sep='|')
...
health_and_medica.to_csv("../data/health_and_medica.csv", sep="|", encoding="UTF-8")
...
hasdotcom.to_csv("../data/hasdotcom.csv", sep="|", encoding="UTF-8")
...
property_payments_solutions.to_csv("../data/property_payments_solutions.csv", sep="|", encoding="UTF-8")
